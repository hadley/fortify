...
#' @return \item{.hat}{Diagonal of the hat matrix}
#' @return \item{.sigma}{Estimate of residual standard deviation when
#'   corresponding observation is dropped from model}
#' @return \item{.cooksd}{Cooks distance, \code{\link{cooks.distance}}}
#' @return \item{.fitted}{Fitted values of model}
#' @return \item{.resid}{Residuals}
#' @return \item{.stdresid}{Standardised residuals}
